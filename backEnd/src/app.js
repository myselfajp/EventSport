...
app.use('/api/v1/performance', authMiddleware, performanceRouter);
app.use('/api/v1/service-requests', authMiddleware, serviceRequestRouter);
app.use('/api/v1/report', validateCSRFToken, authMiddleware, reportRouter);
