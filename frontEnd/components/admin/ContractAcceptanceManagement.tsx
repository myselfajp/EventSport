...
function formatUser(u: AcceptanceRow["user"]): string {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-gray-600 dark:text-slate-400 max-w-3xl">
        ...
        etkinlik kaydı (mesafeli satış / etkinlik sözleşmesi), antrenör profili (statik
        sözleşmeler) ve pazarlama izni.
      </p>
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            placeholder="kvkk, terms, sozlesmeler-ek-1…"
              ...
              <tbody>
                {items.map((row) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-xs max-w-[200px] truncate" title={formatUser(row.user)}>
                      {formatUser(row.user)}
                    </td>
                    <td className="p-3">
